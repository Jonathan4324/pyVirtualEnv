...
OUTPUT_FILE = "new_dataset_H.jsonl"
...
# search_queries = ["Backpack", "Body+Lotion", "Bracelet", "Candles", "Charger", "Chips", "Coffee", "Cookies", "Cushion", 
#                   "Earphones", "Face+Wash", "Gym+Towel", "Hat", "Juice", "Lip+Balm", "Phone+Case", "Picture+Frame", "Power+Bank", "Running+Shoes", 
#                   "Scarf", "Shampoo", "Sunglasses", "Sunscreen", "Table+Lamp", "Tea", "USB+Cable", "Wall+Clock", "Watch", "Water+Bottle", "Yoga+Mat"]
search_queries = ["Backpack"]
